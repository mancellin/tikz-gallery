...
\only<3->{
  ...
  \foreach \x in {0.0, 0.1, ..., 0.9} {\fill (\x, \Minval) circle (0.03);} 
  \foreach \x in {0.9, 1.0, 1.1} {\fill (\x, \Midval+3*\x-3) circle (0.03);} 
  \foreach \x in {1.2, 1.3, ..., 2.0} {\fill (\x, \Maxval) circle (0.03);} 
}
